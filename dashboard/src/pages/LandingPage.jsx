    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-green-100">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="relative max-w-6xl mx-auto group">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-2xl bg-white">
              {/* REPLACE THIS SRC with your actual dashboard screenshot path */}
              <img 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              {/* You can put another screenshot here, maybe the popup view */}
      ...
      <section className="py-24 bg-black text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <button className="bg-green-600 text-white px-10 py-5 rounded-full text-xl font-bold hover:bg-green-500 transition shadow-2xl shadow-green-900/20">
